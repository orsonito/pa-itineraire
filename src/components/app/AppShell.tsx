...
import { QrHeaderButton } from "./QrWallet";
...
function Screen() {
  ...
  return (
    <div className="min-h-dvh bg-[#f4efe6] text-zinc-900">
      ...
      <main className="mx-auto max-w-lg px-5 pb-[calc(5.5rem+env(safe-area-inset-bottom))] pt-5">
...
function tabTitle(tab: string) {
  if (tab === "ruta") return "Ton parcours";
  if (tab === "colas") return "Files d’attente";
  return "Plus";
}
